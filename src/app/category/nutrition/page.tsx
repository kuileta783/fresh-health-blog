...
export default function NutritionPage() {
  ...
  const category = categories.nutrition
  const allProducts = getProductsByCategory("nutrition")
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-lime-600 rounded-full flex items-center justify-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {category.description}. Our nutrition experts analyze ingredients,
                nutritional value, and taste to help you fuel your body right.
              </p>
              ...
              <div className="flex justify-center space-x-8 text-sm">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Taste Tests</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {Object.entries(categories).filter(([key]) => key !== 'nutrition').map(([key, cat]) => (
                <a
                  key={key}
                  href={`/category/${key}`}
