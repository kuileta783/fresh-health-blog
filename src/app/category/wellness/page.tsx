...
export default function WellnessPage() {
  ...
  const category = categories.wellness
  const allProducts = getProductsByCategory("wellness")
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {category.description}. From meditation apps to sleep aids,
                we review products that support your mental health and overall well-being.
              </p>
              ...
              <div className="flex justify-center space-x-8 text-sm">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Hours Tested</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {Object.entries(categories).filter(([key]) => key !== 'wellness').map(([key, cat]) => (
                <a
                  key={key}
                  href={`/category/${key}`}
