...
export default function SupplementsPage() {
  ...
  const category = categories.supplements
  const allProducts = getProductsByCategory("supplements")
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {category.description}. Our experts analyze ingredient quality, bioavailability,
                and third-party testing to help you choose the right supplements.
              </p>

              <div className="flex justify-center space-x-8 text-sm">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{allProducts.length}+</div>
                  <div className="text-gray-600">Supplements Tested</div>
                </div>
                <div className="text-center">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {Object.entries(categories).filter(([key]) => key !== 'supplements').map(([key, cat]) => (
                <a
                  key={key}
                  href={`/category/${key}`}
