...
export default function HomeHealthPage() {
  ...
  const category = categories["home-health"]
  const allProducts = getProductsByCategory("home-health")
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {category.description}. From blood pressure monitors to air purifiers,
                we test medical devices and health equipment for accuracy and reliability.
              </p>

              <div className="flex justify-center space-x-8 text-sm">
                <div className="text-center">
                  <div className="text-2xl font-bold text-teal-600">{allProducts.length}+</div>
                  <div className="text-gray-600">Devices Tested</div>
                </div>
                <div className="text-center">
